			...
			<div class="form section">
				<div class="c_019">
					...
					<form method="post" action="<?php echo PATH_WEB; ?>kapcsolatfelvetel-szerviz" target="_self" id="contactForm">
						...
						<input type="hidden" name="contactType" value="szerviz-2020febr">
						<input type="hidden" name="contactTypeName" value="<?php echo $VIEW["title"]; ?>">
						<fieldset>
							<div class="parsys formBuilder">
								<div class="textfield section">
									<div class="form-group">
										<label for="textfield_3be">Alvázszám*</label>
										<div class="form-group-container">
											<input type="text" class="my-infiniti-input" name="bodyNumber" required value="<?php echo $postData["bodyNumber"]; ?>">
										</div>
									</div>
								</div>
								<div class="textfield section">
