<li class="my-infiniti-newcars-col">
	<div class="c_130">
		...
		<a class="primary-cta cta-explore" href="<?php echo PATH_WEB.$car->url; ?>" target="<?php echo $target; ?>">Adatlap</a>
		<div class="accordion">
			<div class="accordion-group">
				<a class="primary-cta cta-explore" href="<?php echo PATH_WEB.$car->url; ?>#ajanlatkeres" target="<?php echo $target; ?>">Ajánlatkérés</a>
			</div>
		</div>
	</div>
</li>