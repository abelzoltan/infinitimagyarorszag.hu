			...
			<div id="my-infiniti-details-top">
				<div id="my-infiniti-details-top-right">
					<div id="my-infiniti-details-datas">
						<?php foreach($car["main"] AS $mainKey => $data) { ?>
						<div class="my-infiniti-details-data"><?php echo $data["name"]; ?>: <strong><?php echo $data["formatted"]; ?></strong></div>
						<?php } ?>
					</div>
					<div id="my-infiniti-details-prices">
						<?php if(!empty($car["priceListOut"])) { ?>
							<div id="my-infiniti-details-prices-list">
								<div class="my-infiniti-details-data my-infiniti-details-data-del"><?php echo $car["priceListLabel"] ?>:<br><strong><?php echo $car["priceListOut"]; ?></strong></div>
							</div>
						<?php } ?>
						<div id="my-infiniti-details-prices-sale">
							<div class="my-infiniti-details-data"><?php echo $car["priceLabel"]; ?>:<br><strong><?php echo $car["priceOut"]; ?></strong></div>
						</div>
					</div>
				...
				<div id="my-infiniti-details-top-left">
					<?php 
					$count = count($car["pics"]); 
					?>
					<a href="<?php echo $car["defaultPic"]; ?>" class="fancybox" id="my-infiniti-details-img" data-fancybox="gallery" data-caption="1/<?php echo $count.". - ".$car["name"]; ?>"><img src="<?php echo $car["defaultPic"]; ?>" alt="<?php echo $car["name"]; ?>"></a>
					<?php if($count > 1) { ?>
								...
								<div class="my-infiniti-details-gallery-col <?php if($i > 5) { ?>my-infiniti-details-gallery-col-hidden<?php } ?>">
									<div class="my-infiniti-details-gallery-img">
										<div class="my-infiniti-details-gallery-img-outer">
											<a href="<?php echo $pic["url"]; ?>" class="fancybox my-infiniti-details-gallery-img-inner" data-fancybox="gallery" data-caption="<?php echo $iOut."/".$count."."; ?>"><img src="<?php echo $pic["url"]; ?>" alt="<?php echo $iOut."/".$count."."; ?>" class="img-responsive center vertical-middle"></a>
										</div>
									</div>
								</div>
								<?php
						...
						<div id="my-infiniti-hil-details-datas-right">
							...
							{ 
								...
								<div class="my-infiniti-hil-details-datas-prices">
									<?php
									foreach($car["prices"] AS $key => $data)
									{
										?>
										<div class="row my-infiniti-hil-details-datas-row">
											...
											<div class="my-infiniti-hil-details-datas-col-right my-infiniti-hil-details-datas-col-under"><?php echo $data["formatted"]; ?></div>
											<div class="my-infiniti-clear"></div>
											<div class="my-infiniti-hil-details-datas-col-left"><?php echo $data["name"]; ?>:</div>	
											<div class="my-infiniti-hil-details-datas-col-right"><?php echo $data["formatted"]; ?></div>	
										</div>
										<?php
									}
									?>
							...
							if(!empty($car["text"])) 
							{
								...
								<div class="my-infiniti-hil-details-text-container">
									<h3 class="my-infiniti-hil-details-text-title">Részletek</h3>	
									<div class="my-infiniti-hil-details-text"><?php echo $car["text"]; ?></div>	
								</div>
								<?php
							}
							?>
						...
						<div id="my-infiniti-hil-details-datas-left">
							...
							{ 
								...
								<div class="my-infiniti-hil-details-datas-others">
									<?php
									foreach($car["datas"] AS $key => $data)
									{
										if($key == "emailcim") { $data["formatted"] = '<a href="mailto:'.$data["value"].'" target="_blank">'.$data["value"].'</a>'; }
										?>
										<div class="row my-infiniti-hil-details-datas-row">
											<div class="my-infiniti-hil-details-datas-col-left my-infiniti-hil-details-datas-col-under"><?php echo $data["name"]; ?>:</div>	
											<div class="my-infiniti-hil-details-datas-col-right my-infiniti-hil-details-datas-col-under"><?php echo $data["formatted"]; ?></div>
								...
								<div class="my-infiniti-hil-details-eparator"></div>
								<?php
							} 
