...
<head>
	...
	<meta name="facebook-domain-verification" content="vnj54k7thiy4df216sobvtostrcmkj" />
	...
	<link rel="stylesheet" media="print, screen" href="<?php echo DIR_PUBLIC_WEB; ?>css/infiniti.min.css">
	<style>
		<?php
	...
	<!-- Hotjar Tracking Code for https://www.infinitimagyarorszag.hu/ -->
	<script>
		(function(h,o,t,j,a,r){
			h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
			h._hjSettings={hjid:1888783,hjsv:6};
		...
		<div class="c_128" id="cookies">
			<div class="cookies-row">
				<div class="cookies-content">
					...
					<p>A weboldal cookie-kat használ. Ha továbblép, azzal beleegyezik a cookie-k használatába. További részletekért lásd a <a href="https://www.infiniti.hu/cookie.html" target="_blank">Cookie szabályzatunkat</a>.</p>
...
<!--														<li><a itemprop="url" href="--><?php //echo PATH_WEB; ?><!--keszleteink" target="_self" title="--><?php //echo $texts["menuStockCar"]; ?><!--">--><?php //echo $texts["menuStockCar"]; ?><!--</a></li>-->
				...
				<div class="grid-row">
					<div class="col-12">
						...
						<dl class="col-4" style="border-bottom: 0;">
							...
							<dd><a href="<?php echo PATH_WEB; ?>keszleteink" target="_self"><span>Készlet</span></a></dd>
							<?php /*<dd><a href="<?php echo PATH_WEB; ?>approved" target="_self"><span>Használt autók</span></a></dd>*/ ?>
						</dl>
				...
				<div class="grid-row">
					<div class="col-12">
						<ul class="footer-options">
							<li><a href="<?php echo INFINITI_HU; ?>" target="_blank">Infiniti.hu</a></li>
							<li><a href="<?php echo INFINITI_HU; ?>cookie.html" target="_blank">Cookie információk</a></li>
							<li><a href="<?php echo INFINITI_HU; ?>privacy.html" target="_blank">Adatkezelés</a></li>
							<li><a href="<?php echo INFINITI_HU; ?>legal.html" target="_blank">Jogi nyilatkozat</a></li>
						</ul>
		...
		<div id="mymodal-callback" class="mymodal">
			<form class="mymodal-content" action="<?php echo PATH_WEB; ?>visszahivas" method="post" target="_self">
				<div class="mymodal-header">
					<span>Szüksége van személyes tanácsadásra a választáshoz?<br>Kérjen visszahívást!</span>
					<span class="close" onclick="modalClose('mymodal-callback')">&times;</span>
				</div>
				<div class="mymodal-body">
					<div style="margin-bottom: 2em;"><a href="https://keszletauto.hu/" target="_blank"><img src="<?php echo PATH_WEB; ?>pics/keszletauto-akcio.jpg" alt="" class="img-responsive center"></a></div>
							...
							<div class="form-group">
								...
								<div class="form-group-container">
									<select name="subject" class="my-infiniti-select" required>
										...
										<?php /*<option value="M3, Szerviz" <?php if($postData["subject"] == "M3, Szerviz") { ?>selected<?php } ?>>Szerviz (M3)</option>*/ ?>
					...
					<div class="checkbox section">
						<div class="form-group checkbox">
							<span class="help-block">
								<p>
									Elérhetőségei megadásával hozzájárul, hogy az INFINITI a jövőben értesítse az INFINITI vel kapcsolatos hírekről.<br>
	...
	if(isset($VIEW["vars"]["notificationPopup"]) AND $VIEW["vars"]["notificationPopup"] !== false)
	{
		if(empty($VIEW["vars"]["notificationPopup"]->timeBetweenShow)) { unset($_SESSION[SESSION_PREFIX."notificationPopupDate"]); }
		if(
			!isset($_SESSION[SESSION_PREFIX."notificationPopupDate"]) OR (
				!empty($VIEW["vars"]["notificationPopup"]->timeBetweenShow) AND 
				$_SESSION[SESSION_PREFIX."notificationPopupDate"] < date("Y-m-d H:i:s", strtotime($VIEW["vars"]["notificationPopup"]->timeBetweenShow))
			)			
		){
			?>
			<div id="mymodal-notification-popup" class="mymodal">
				<div class="mymodal-content" style="max-width: 900px;">
					<div class="mymodal-header">
						<span><?php echo $VIEW["vars"]["notificationPopup"]->name; ?></span>
						<span class="close" onclick="modalClose('mymodal-notification-popup')">&times;</span>
					</div>
					<div class="mymodal-body" style="text-align: justify; font-size: 120%; text-align: justify;"><?php echo $VIEW["vars"]["notificationPopup"]->text; ?></div>
				</div>
			</div>
			<script>
				$(document).ready(function(){
					modalOpen("mymodal-notification-popup");
					setTimeout(function(){
						modalClose("mymodal-notification-popup");
					}, 25000);
				});
			</script>
			<?php
			$_SESSION[SESSION_PREFIX."notificationPopupDate"] = date("Y-m-d H:i:s");
		}
	}
	?>
