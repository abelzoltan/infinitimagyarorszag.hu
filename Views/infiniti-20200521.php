...
<head>
	...
	<link rel="stylesheet" media="print, screen" href="<?php echo DIR_PUBLIC_WEB; ?>css/infiniti.css?v=20200319">
	<style>
		<?php
...
<body>
				...
				<div class="grid-row">
					<div class="col-12">
						...
						<dl class="col-4" style="border-bottom: 0;">
							...
							<dd><a href="<?php echo PATH_WEB; ?>uj-autok" target="_self"><span>Autók</span></a></dd>
							<dd><a href="<?php echo PATH_WEB; ?>keszleteink" target="_self"><span>Készlet</span></a></dd>
							<dd><a href="<?php echo PATH_WEB; ?>approved" target="_self"><span>Használt autók</span></a></dd>
						</dl>
	...
	if(!isset($_SESSION[SESSION_PREFIX."coronavirusPopUpDate"]) OR $_SESSION[SESSION_PREFIX."coronavirusPopUpDate"] < date("Y-m-d H:i:s", strtotime("-4 hours")))
	{
		?>
		<div id="mymodal-corona" class="mymodal">
			<div class="mymodal-content">
				<div class="mymodal-header">
					<span>Tisztelt Ügyfelünk!</span>
					<span class="close" onclick="modalClose('mymodal-corona')">&times;</span>
				</div>
				<div class="mymodal-body" style="text-align: justify; font-size: 110%; text-align: justify;">
					A május 16.-ai kormányrendelet értelmében május 19-től a Gablini Autószalonok ismét várja márkaközpontjaiban az új gépjármű és szerviz szolgáltatások iránt érdeklődőket az alábbi nyitva tartás szerint:<br>
					<br>
					Új gépjármű értékesítés: <strong>H-P: 08:00-16:00, Szo: 09:00-14:00</strong><br>
					Szerviz szolgáltatások: <strong>H-P: 07:00-16:00</strong><br>
					<br>
					A megszokott magas színvonalú szolgáltatás mellett minden javasolt protokolt betartunk és betartatunk, mind ügyfeleink, mind pedig munkatársaink egészsége érdekében. Kiemelten fontosnak tarjuk, hogy a szigorú szabályok betartása mellett, biztosítsuk a személy és kisteherautók működőképességét, magánszemélyek, vállalkozások mobilitásának a megőrzését.<br>
					<br>
		...
		<script>
			$(document).ready(function(){
				modalOpen("mymodal-corona");
				setTimeout(function(){
					modalClose("mymodal-corona");
				}, 25000);	
				$.ajax({
					type: "POST",
					url: "<?php echo PATH_WEB; ?>koronavirus-ablak",
					dataType: "html",
					success: function(msg){
					},
				});
