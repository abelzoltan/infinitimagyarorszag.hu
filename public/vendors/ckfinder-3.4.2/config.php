...
$config['authentication'] = function () {
	if(isset($_SESSION["ckfinderAuthentication"]) AND $_SESSION["ckfinderAuthentication"]) { return true; }
	else { return false; }
};
...
if(isset($_SESSION["ckfinderBaseURL"]) AND !empty($_SESSION["ckfinderBaseURL"])) { $baseURL = $_SESSION["ckfinderBaseURL"]; }
else { $baseURL = "files/ckfinder/"; }

if(isset($_SESSION["ckfinderRoot"]) AND !empty($_SESSION["ckfinderRoot"])) { $root = $_SESSION["ckfinderRoot"]; }
else { $root = __DIR__."/../../files/ckfinder/"; }
